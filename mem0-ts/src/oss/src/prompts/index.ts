...
export function getTextTagRetrievalMessages(
  ...
  const systemPrompt = `You are a Personal Information Organizer, specialized in accurately storing facts, tags, user memories, and preferences. 你的主要职责是从对话中抽取出与下列标签相关的信息，并将这些信息组织成独立的、可管理的 facts. This allows for easy retrieval and personalization in future interactions. Below are the types of information you need to focus on and the detailed instructions on how to handle the input data.
    ...
    1. weather: 天气
    2. color: 颜色
    Output: {"facts" : [], "tagNamesList" : []}
    
    Input: The sky is blue and the grass is green.
    Tags: 
    1. weather: 天气
    2. color: 颜色
    Output: {"facts" : ["Sky is blue", "Grass is green"], "tagNamesList" : [["weather", "color"], ["color"]]}
    
    Input: Hi, I am looking for a restaurant in San Francisco.
    Tags: 
    1. location: 位置 
    Output: {"facts" : ["Looking for a restaurant in San Francisco"], "tagNamesList" : ["location]}
    
    Input: Yesterday, I had a meeting with John at 3pm. We discussed the new project.
    Tags: 
    1. time: 时间
    2. person: 人
    Output: {"facts" : ["Had a meeting with John at 3pm", "Discussed the new project"], "tagNamesList" : [["time", "person"], ["person"]]}
    
    Input: Hi, my name is John. I am a software engineer.
    Tags: 
    1. name: 名字
    2. job: 职业
    Output: {"facts" : ["Name is John", "Is a Software engineer"], "tagNamesList" : [["name", "job"], ["job"]]}
    
    Input: Me favourite movies are Inception and Interstellar.
    Tags: 
    1. movie: 电影
    Output: {"facts" : ["Favourite movies are Inception and Interstellar"], "tagNamesList" : [["movie"]]}
    
    Return the facts, tagNamesList and preferences in a JSON format as shown above. 请返回一个包含 facts 键和 tagNamesList 键的有效 JSON 对象，其中 facts 的值为字符串数组，tagNamesList 的值也为字符串数组.
          ...
          - **Example**:
              - Old Memory:
                  [
                      {
                          "id" : "0",
                          "text" : "[job] User is a software engineer",
                          "tag_names" : ["job"]
                      }
                  ]
              - Retrieved facts: [{"text" : "Name is John", "tag_names" : ["name"]}]
              - New Memory:
                  {
                      "memory" : [
                          {
          ...
          - **Example**:
              - Old Memory:
                  [
                      {
                          "id" : "0",
                          "text" : "[food] I really like cheese pizza",
                          "tag_names" : ["food"]
                      },
                      {
                          "id" : "1",
              ...
              - Retrieved facts: [{"text" : "Loves chicken pizza", "tag_names" : ["food"]}, {"text" : "Loves to play cricket with friends", "tag_names" : ["job"]}]
              - New Memory:
                  {
                      "memory" : [
                          {
                              "id" : "0",
                              "text" : "[food] Loves cheese and chicken pizza",
                              "tag_names" : ["food"],
                              "event" : "UPDATE",
                              "old_tag_names" : ["food"],
                              "old_memory" : "[food] I really like cheese pizza"
                          },
                          {
                              "id" : "1",
                              "text" : "[job] User is a software engineer",
                          ...
                          },
                          {
                              ...
                              "event" : "UPDATE",
                              "old_tag_names" : ["job"],
                              "old_memory" : "[job] User likes to play cricket"
                          }
                      ]
                  }
          ...
          - **Example**:
              - Old Memory:
                  [
                      ...
                      {
                          "id" : "1",
                          "text" : "[food] Loves cheese pizza",
                          "tag_names" : ["food"]
                      }
                  ]
              - Retrieved facts: [{"text" : "Dislikes cheese pizza", "tag_names" : ["food"]}]
              - New Memory:
                  {
                      "memory" : [
                          {
